...
function (ko, FunctionViewModel, ConceptSelectViewModel, select2Query) {
    return ko.components.register('views/components/functions/required_node', {
        viewModel: function(params) {
            ...
            //this.selected_value = params.config.selected_value;
        ...
        template: {
            require: 'text!templates/views/components/functions/required_node.htm'
        }
